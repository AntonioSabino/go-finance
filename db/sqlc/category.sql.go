...
func (q *Queries) UpdateCategy(ctx context.Context, arg UpdateCategyParams) (Category, error) {
	row := q.db.QueryRowContext(ctx, updateCategy, arg.ID, arg.Title, arg.Description)
	var i Category
	err := row.Scan(
		&i.ID,
		&i.UserID,
